...
<title>Nayem - Web desin & developer</title>
<!-- Favicon-->
...
<div class="container">
<a class="navbar-brand" href="#page-top"><img src="assets/img/nayem_logo.png" alt="..." /></a>
...
<div class="col-lg-4 col-sm-6 mb-4">
    ...
    <div class="portfolio-item">
        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal<?php echo $portfolio->id?>">
            ...
            <img class="img-fluid" src="{{url($portfolio->small_image)}}" alt="small_image" />
        </a>
